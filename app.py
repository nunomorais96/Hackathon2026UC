...
if run_button:
    ...
    with st.spinner("Risk Agent is calculating risk scores..."):
        df = add_risk_analysis(df, profile=risk_profile, horizon=horizon)
    ...
    st.header("2. 1-Year Price Evolution")
    ...
    st.header("5. Final Investment Brief")
